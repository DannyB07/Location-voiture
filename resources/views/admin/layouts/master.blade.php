...
<body>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                    ...
                    <li><a class="text-light btn btn-danger" href="{{ route('admin.logout.perform') }}">Déconnexion</a></li>
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ route('admin.car.index') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-car glowing-car"></i></div>
                            Voitures
                        </a>
                        ...
                        <a class="nav-link" href="{{ route('admin.marque.index') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Marques
                        </a>
