        ...
        <section class="row row--grid">
            ...
            <div class="col-12 col-lg-5">
                <div class="offer">
                    ...
                    <form id='rent-form' class="offer__list" action="{{ route('reservation.store', ['id' => $car->id]) }}" method="post">
                    @csrf
                    <!-- Vos champs de formulaire -->
                    <ul class="offer__list">
                        <li>
                            <span class="offer__list-name">Nom </span>
                            <div class="sign__group">
                                <input type="text" id="last_name" name="last_name" class="sign__input" required>
                            </div>
                        </li>
                        <li>
                            <span class="offer__list-name">Prénom </span>
                            <div class="sign__group">
                                <input type="text" id="first_name" name="first_name" class="sign__input" required>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="sign__group">
                                <ul class="sign__radio">
                                    <li>
                                        <input id="terms" type="checkbox" value="1" name="terms" required>
                                        <label for="terms">J'accepte les <a href="#"><strong>conditions d'utilisation</strong></a></label>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    @if ($car->available)
                    <button type="submit" class="offer__rent open-modal" id="rent-btn">Réserver</button>
                    @else
